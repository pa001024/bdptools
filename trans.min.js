...
!function(){function t(t,n){var e=downFileButton||document.createElement("a");e.rel="noreferrer",e.download=t,e.href=n;var a=require("common:widget/toast/toast.js");a.obtain.useToast({toastMode:a.obtain.MODE_SUCCESS,msg:"直链转化成功 点击下载按钮或右键复制链接到下载工具进行下载",sticky:!0,position:4096,closeType:!0})}function n(){B.transferFileAsync(yunData.SHARE_ID,yunData.SHARE_UK,yunData.FILENAME,e).then(function(n){B.getMetaAsync(e+"/"+yunData.FILENAME).then(function(n){t(n.server_filename,n.dlink)})})}if("object"!=typeof yunData)return alert('Σ(⊙▽⊙"a...当前不是分享页面或者页面加载不正确\n请刷新页面再试哦');if(!yunData.MYUK)return alert("_(￣0￣)_~ 请登录后再进行操作");var e="/tmp";B.getMetaAsync("/tmp").then(n,function(t){-9==t.info[0].errno&&B.createDirAsync("/tmp").then(n)})}();